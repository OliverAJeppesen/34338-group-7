...
const char* ssid = "PET"; //Write your SSID
const char* password = "negerskyder1";   //Write your password

const char* input_parameter = "state";

const int output = D2;
const int Push_button_GPIO = D4 ;
...
<!DOCTYPE HTML><html>
<head>
  <title>Security System Server</title>
...
String processor(const String& var){
  if(var == "BUTTONPLACEHOLDER"){
    ...
    buttons+= "<h4>Alarm state: <span id=\"outputState\"></span></h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"output\" " + outputStateValue + "><span class=\"slider\"></span></label>";
    return buttons;
  }
  return String();
}
